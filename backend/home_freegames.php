<?php
	...
	$getlist = "SELECT * FROM games WHERE baseprice = 0";
			...
			echo "
					<div class='card text-bg-dark me-1 custom_card_min_width custom_card_max_width'>
						...
						<div class='card-img-overlay'>
							<form method='GET'>
								<button type='submit' class='btn btn-sm btn-primary custom_btn_opacity_35 col-12' name='submit_viewgamepage' value='" . $row['id'] . "'>Free</button>
							</form>
						</div>
					</div>
				";
