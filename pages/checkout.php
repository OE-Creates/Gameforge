<?php
	...
	require "../backend/checkout_logic.php";
?>
<!doctype html>
<html lang="en">
	<head>
		...
		<div class="container">
			...
			<div class="row mt-1 bg-dark custom_border_radius_5">
				<div class="col">
					...
					<h4 class="text-white mt-2 mb-1 d-flex">Checkout</h4>
					
					<div class="container my-2 custom_div_height_300 py-2 bg-light custom_border_radius_5 custom_div_overflow_y">
						<?php require "../backend/checkout_itemlist.php"; ?>
					</div>
					
					<div class="container my-2 py-2 bg-light custom_border_radius_5" style="height: 48px; ">
						<h3>Total: Ksh <?php echo $_SESSION["chkout_totalcost"]; ?></h3>
					</div>
					
					<form method="GET">
						<div class="d-flex justify-content-end col-md">
							<button type="submit" class="btn btn-outline-warning col-md-3 mb-2" name="submit_proceedtopay">PROCEED</button>
						</div>
					</form>
