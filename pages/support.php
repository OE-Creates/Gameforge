...
<html lang="en">
	...
	<body>
		...
		<div class="container">
			...
			<div class="row mt-1 bg-dark custom_border_radius_5">
				<div class="col">
					...
					<div class="mt-2 d-flex">
						<h4 id="contactus" class="text-white">Contact Us</h4>
					</div>
					...
					<div class="mt-1 mb-2">
						...
						<section>
							...
							<!--Section description-->
							<p class="w-responsive mx-auto mb-3 text-white">Do you have any questions? Please do not hesitate to contact us directly. Our team will get back to you within a matter of hours to help you.</p>
									...
									<form method="POST">
										...
										<div class="row">
											...
											<div class="col-md-6 mb-2">
												<div class="form-floating md-form mb-0">
													<input type="text" id="contactformusername" name="contactform_username" class="form-control" placeholder="valid_username" pattern="[A-Za-z0-9@#&_-+ ]+" minlength="5" maxlength="25" title="Input your username using letters (UPPERCASE or lowercase) and numbers only." required>
													<label for="contactformusername" class="">Your Username</label>
												</div>
											</div>
											<!--Grid column-->
											...
											<div class="col-md-6 mb-2">
												<div class="form-floating md-form mb-0">
													<input type="text" id="contactformemail" name="contactform_email" class="form-control" placeholder="valid_email" pattern="[A-Za-z0-9._@]+" minlength="5" maxlength="30" required>
										...
										<div class="row">
											<div class="col-md-12 mb-2">
												<div class="form-floating md-form mb-0">
													<input type="text" id="contactformsubject" name="contactform_subject" class="form-control" placeholder="valid_subject" pattern="[A-Za-z0-9 ]+" minlength="3" maxlength="30" title="Input an appropriate subject using letters (UPPERCASE or lowercase) and numbers only."required>
													<label for="contactformsubject" class="">Subject</label>
												</div>
											</div>
										</div>
										<!--Grid row-->
										...
										<div class="row">
											...
											<div class="col-md-12 mb-2">
												...
												<div class="md-form">
													<label for="contactformmessage" class="text-white">Your message</label>
													<textarea type="text" id="contactformmessage" name="contactform_message" rows="4" class="form-control md-textarea" pattern="[A-Za-z0-9 ]+" minlength="5" maxlength="255" title="Input a description using letters (UPPERCASE or lowercase) and numbers only." required></textarea>
												</div>
										...
										<div class="text-center text-md-left">
											<button type="submit" name="submit_contactform" class="btn btn-primary col-6">Send</button>
										</div>
										<div class="status text-info"><?php require "../backend/contactform_send.php"; ?></div>
			...
			<div class="row mt-2 bg-dark custom_border_radius_5">
				<div class="col">
					...
					<div class="mt-2 d-flex">
						<h4 id="forgotpassword" class="text-white">Forgot Credentials</h4>
					</div>
					<hr style="color:white;" class="my-0">
					<div class="mt-1 mb-2">
						<form method="POST">
							<?php require "../backend/support_forgotdetails.php"; ?>
						</form>
					</div>
		...
		<nav class="navbar navbar-expand-lg">
			<div class="container navbar-dark bg-dark custom_border_radius_5">
				<p class="d-flex justify-content-between text-white my-2">GameForge: <a class="nav-link mx-4" href="policy.php">Policies</a><a class="nav-link me-4" href="legal.php">Legal</a><a class="nav-link" href="#">Support</a></p>
			</div>
		</nav>
