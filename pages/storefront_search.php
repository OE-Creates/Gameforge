<?php
	...
	require "../backend/storefront_logic.php";
?>
<!doctype html>
<html lang="en">
	<head>
			...
			<div class="container navbar-dark bg-dark custom_border_radius_5">
				...
				<div class="collapse navbar-collapse" id="navbarColor01">
					<ul class="navbar-nav me-auto">
					  <li class="nav-item">
						<a class="nav-link active" href="storefront.php">STORE</a>
					  </li>
					  <li class="nav-item">
					...
					<div class="my-2 w-100">
						...
						<div class="row">
							<div class="col">
								...
								<div class="container bg-secondary mt-1 custom_border_radius_5">
									<h5 class="text-white pt-1">Games</h5>
									
									<form method="POST">
										<div class="input-group mb-2">
											<input class="form-control" type="text" placeholder="Search" value="<?php echo $_SESSION["searched_game"]; ?>" name="store_searchbox" required>
											<button type="submit" class="btn btn-secondary" name="submit_storesearch">
												<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
												<path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"></path>
												</svg>
											</button>
									...
									<form method="POST">
										<div class="input-group mb-2">
											<button type="submit" class="btn btn-secondary" value="a" name="submit_storefilter">A</button>
											<button type="submit" class="btn btn-secondary" value="b" name="submit_storefilter">B</button>
											<button type="submit" class="btn btn-secondary" value="c" name="submit_storefilter">C</button>
											<button type="submit" class="btn btn-secondary" value="d" name="submit_storefilter">D</button>
											<button type="submit" class="btn btn-secondary" value="e" name="submit_storefilter">E</button>
											<button type="submit" class="btn btn-secondary" value="f" name="submit_storefilter">F</button>
											<button type="submit" class="btn btn-secondary" value="g" name="submit_storefilter">G</button>
											<button type="submit" class="btn btn-secondary" value="h" name="submit_storefilter">H</button>
											<button type="submit" class="btn btn-secondary" value="i" name="submit_storefilter">I</button>
											<button type="submit" class="btn btn-secondary" value="j" name="submit_storefilter">J</button>
											<button type="submit" class="btn btn-secondary" value="k" name="submit_storefilter">K</button>
											<button type="submit" class="btn btn-secondary" value="l" name="submit_storefilter">L</button>
											<button type="submit" class="btn btn-secondary" value="m" name="submit_storefilter">M</button>
											<button type="submit" class="btn btn-secondary" value="n" name="submit_storefilter">N</button>
											<button type="submit" class="btn btn-secondary" value="o" name="submit_storefilter">O</button>
											<button type="submit" class="btn btn-secondary" value="p" name="submit_storefilter">P</button>
											<button type="submit" class="btn btn-secondary" value="q" name="submit_storefilter">Q</button>
											<button type="submit" class="btn btn-secondary" value="r" name="submit_storefilter">R</button>
											<button type="submit" class="btn btn-secondary" value="s" name="submit_storefilter">S</button>
											<button type="submit" class="btn btn-secondary" value="t" name="submit_storefilter">T</button>
											<button type="submit" class="btn btn-secondary" value="u" name="submit_storefilter">U</button>
											<button type="submit" class="btn btn-secondary" value="v" name="submit_storefilter">V</button>
											<button type="submit" class="btn btn-secondary" value="w" name="submit_storefilter">W</button>
											<button type="submit" class="btn btn-secondary" value="x" name="submit_storefilter">X</button>
											<button type="submit" class="btn btn-secondary" value="y" name="submit_storefilter">Y</button>
											<button type="submit" class="btn btn-secondary" value="z" name="submit_storefilter">Z</button>
										</div>
									</form>
									...
									<div>
										<div class="row custom_div_height_750 custom_div_overflow_y">
											
											<?php require "../backend/storefront_results.php"; ?>
