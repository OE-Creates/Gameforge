...
<html lang="en">
	...
	<body>
		...
		<div class="container">
			...
			<div class="row mt-1 bg-dark custom_border_radius_5">
				<div class="col">
					...
					<div class="mt-2 d-flex">
						<h4 class="text-white">COPYRIGHT</h4>
					</div>
					<hr style="color:white;" class="my-0">
					<div class="mt-1 mb-2 text-white">
						© 2022 GameForge.io. All rights reserved. GameForge, the GameForge logo, are trademarks and/or registered trademarks of GameForge Corporation. All other trademarks are property of their respective owners.
					</div>
			...
			<div class="row mt-2 bg-dark custom_border_radius_5">
				<div class="col">
					...
					<div class="mt-2 d-flex">
						<h4 class="text-white">THIRD PARTY LEGAL NOTICES</h4>
					</div>
					<hr style="color:white;" class="my-0">
					<div class="mt-1 mb-2 text-white">
						GameForge products distributed via GameForge.io use certain third party materials that require notifications about their license terms. You can find a list of these notifications in the file called ThirdPartyLegalNotices.doc at <a href="#" class="text-decoration-none">thirdpartylegalnotices.com</a>. Where license terms require GameForge to make source code available for redistribution, notify GameForge Staff via <a href="support.php#contactus" class="text-decoration-none">this</a> page.
					</div>
			...
			<div class="row mt-2 bg-dark custom_border_radius_5">
				<div class="col">
					...
					<div class="mt-2 d-flex">
						<h4 class="text-white">CLAIMS OF COPYRIGHT INFRINGEMENT</h4>
					</div>
					<hr style="color:white;" class="my-0">
					<div class="mt-1 mb-2 text-white">
						GameForge respects the intellectual property rights of others, and we ask that everyone using our internet sites and services do the same. Anyone who believes that their work has been reproduced in one of our internet sites or services in a way that constitutes copyright infringement may notify GameForge via <a href="support.php#contactus" class="text-decoration-none">this</a> page.<br><br>
						More information about Kenya copyright law can be found at the Kenya Copyright Office <a href="https://copyright.go.ke" class="text-decoration-none">https://copyright.go.ke</a>
					</div>
		...
		<nav class="navbar navbar-expand-lg">
			<div class="container navbar-dark bg-dark custom_border_radius_5">
				<p class="d-flex justify-content-between text-white my-2">GameForge: <a class="nav-link mx-4" href="policy.php">Policies</a><a class="nav-link me-4" href="#">Legal</a><a class="nav-link" href="support.php">Support</a></p>
			</div>
		</nav>
